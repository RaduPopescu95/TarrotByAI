...
const AppointmentFilters = ({
  ...
  const renderDefaultOptions = () => (
    <>
      ...
      <View style={styles.row}>
        <Text>{i18n.translate("registeredPacient")}</Text>
        <Switch
          value={registeredPatient}
          onValueChange={setRegisteredPatient}
        />
      </View>

      <View style={styles.row}>
        <Text>{i18n.translate("unregisteredPacient")}</Text>
        <Switch
          value={unregisteredPatient}
          onValueChange={setUnregisteredPatient}
        />
      </View>
      <View style={styles.row}>
        ...
        >
          ...
          <List.Section title={i18n.translate("sortBy")}>
            ...
            >
              ...
              <View style={styles.row}>
                <Text>{i18n.translate("pacientName")}</Text>
                <RadioButton value={i18n.translate("pacientName")} />
              </View>
              <View style={styles.row}>
...
AppointmentFilters.title = "Appointments Filters";
