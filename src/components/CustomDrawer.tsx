...
//         <ImageBackground
//           source={require('../images/smallicon.jpeg')}
//           style={{padding: 20}}>
//           <Image
//             source={{uri: patientInformation.patientImage ? patientInformation.patientImage : clinicInformation.clinicMainImage ? clinicInformation.clinicMainImage.img: ""}}
