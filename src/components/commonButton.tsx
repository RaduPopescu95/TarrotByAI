...
export const ButtonFull: React.FC<ButtonProps> = ({
  ...
  return (
    <CommonButtonBlue
      disabled={disabled}
      style={[style, success ? {backgroundColor: bgColor ? bgColor : colors.blue} : null]}
      onPress={() => {
        funCallback();
      }}>
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <CommonButton
      ...
      style={[style, success ? {backgroundColor:bgColor ? bgColor : transparent ? "transparent" :  colors.blue} : null, {borderWidth:borderWidth, borderColor}]}
      
      onPress={() => {
        funCallback();
      }}>
      <ButtonText style={{color:txtColor ? txtColor : "black"}}>{label}</ButtonText>
    </CommonButton>
  );
};
