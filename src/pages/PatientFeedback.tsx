...
const PatientFeedback: React.FC<Props> = ({
          ...
          <>
            <View style={styles.bodyStyle}>
              ...
              <View style={styles.emailBoxContainerStyle}>
                <TextInput
                  placeholder={i18n.translate("provideEmail")}
              ...
              <View style={styles.textBoxContainerStyle}>
                <TextInput
                  placeholder={i18n.translate("describeFeedback")}
                  style={[pl15, {fontSize: 11, paddingTop: 5}]}
            ...
            <TouchableOpacity
              ...
              <H14fontRegularWhite>{i18n.translate("sendFeedback")}</H14fontRegularWhite>
              {/* <H14fontRegularBlack>Send feedback</H14fontRegularBlack> */}
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.nextButtonStyle}
              onPress={() => Linking.openURL('mailto:mobitoolsro@example.com')}>
              <H14fontRegularWhite>{i18n.translate("contactViaEmail")}</H14fontRegularWhite>
            </TouchableOpacity>
            {/* <TouchableOpacity
              style={styles.nextButtonStyle}
