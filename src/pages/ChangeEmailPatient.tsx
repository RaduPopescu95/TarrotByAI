...
const ChangeEmailPatient: React.FC<Props> = ({
  navigation,
  route,
}): JSX.Element => {
  ...
  await reauthenticateWithCredential(user, credential).then( async () => {
     ...
     await updateEmail(user, newEmail).then(() => {
      ...
      if(err.code == "auth/wrong-password"){
        Alert.alert(i18n.translate("wrongCurrentPass"), i18n.translate("wrongCurrentPassMessage"), [
        
          {text: 'OK', onPress: () => console.log('OK Pressed')},
        ]);
      } else if(err.code == "auth/too-many-requests"){
        Alert.alert(i18n.translate("tooManyWrongCurrentPassEntries"), i18n.translate("tooManyWrongCurrentPassEntriesMessage"), [
          {text: i18n.translate("logOut"), onPress: () => handleSignOut(navigation, true)},
          {text: 'OK', onPress: () => console.log('OK Pressed')},
        ]);
        
      } else if(err.code == "auth/email-already-in-use"){
        Alert.alert(i18n.translate("emailAlreadyInUse"), i18n.translate("emailAlreadyInUseMessage"), [
          {text: i18n.translate("tryAgain"), onPress: () => console.log("try again...")},
          // {text: 'OK', onPress: () => console.log('OK Pressed')},
        ]);
        
      } else {
        Alert.alert(i18n.translate("problemOccured"), i18n.translate("problemOccuredMessage"), [
          {text: i18n.translate("contact"), onPress: () => navigation.navigate(screenName.Feedback)},
          {text: 'OK', onPress: () => console.log('OK Pressed')},
        ]);
      }
...
export default ChangeEmailPatient;
