  ...
  return (
    ...
    <Fragment>
      <MainContainer>
       ...
       <H6fontBoldPrimary>{i18n.translate("signUp")}</H6fontBoldPrimary> 
              ...
              <View>
                {registerType === "email" && (
                  <Controller
                    ...
                    rules={{
                      required: requiredValidation(i18n.translate("firstName")),
                ...
                {registerType === "email" && (
                  <Controller
                    ...
                    rules={{
                      required: requiredValidation(i18n.translate("lastName")),
